<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-foreground leading-tight">Lapor Kondisi Barang</h2>
    </x-slot>
            ...
            <div class="glass-card p-6">
                ...
                <form method="POST" action="{{ route('kondisi.store', $barang) }}" enctype="multipart/form-data">
                    ...
                    <div class="flex gap-2">
                        ...
                        <a href="{{ route('barang.show', $barang) }}" class="px-4 py-2 bg-secondary text-foreground rounded hover:bg-accent">Batal</a>
                    </div>
                </form>
            </div>
        </div>
